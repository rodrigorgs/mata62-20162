...
layout: page
title:  "Refatoração"
date:   2017-02-17 20:20:00 -0300
categories: aula
---

- Livro: [Refactoring: Ruby Edition](https://www.amazon.com/Refactoring-Ruby-Addison-Wesley-Professional-ebook/dp/B002TIOYWG) (capítulo 1)
- [Exemplo no GitHub](https://github.com/chap/Refactoring-Ruby-Edition/commits/master)
...
class VideoRentalTest < Test::Unit::TestCase
  ...
  def test_statement
    ...
    assert_equal "Rental Record for Chap\n"          +
                 "\tJoe Versus the Volcano\t6.5\n"   +
                 "Valor devido: 6.5\n"              +
                 "Voce ganhou 1 pontos de fidelidade", customer.recibo
    ...
    assert_equal "Rental Record for Chap\n"          +
                 ...
                 "\tSleepless in Seattle\t1.5\n"     +
                 "Valor devido: 8.0\n"              +
                 "Voce ganhou 2 pontos de fidelidade", customer.recibo
    ...
    assert_equal "Rental Record for Chap\n"          +
                 ...
                 "\tYou've Got Mail\t45\n"           +
                 "Valor devido: 53.0\n"             +
                 "Voce ganhou 4 pontos de fidelidade", customer.recibo
  end
end
```